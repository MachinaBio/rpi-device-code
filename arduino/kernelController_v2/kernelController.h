...
const double aggKp=60, aggKi=0, aggKd=0; // AGGRESSIVE: proportional band +/- 2.0C 
const double consKp=30, consKi=.25, consKd=0; // CONSERVATIVE: proportional band +/- 8

// Substage Heater 
const double ssKp=30, ssKi=0.1, ssKd=0;

// Humidity Heater 
// const double humKp=5, humKi=0.2, humKd=0; // for humidity
const double humKp=30, humKi=.25, humKd=0; // for temperature
