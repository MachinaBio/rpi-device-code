...
AqsPID chamberPID = AqsPID();
AqsPID humidityPID = AqsPID();
AqsPID substagePID = AqsPID();
AqsPID objectivePID = AqsPID();
...
void setup() {
  ...
  lcd.setCursor(1,0);
  lcd.print("Controller v1"); 
  lcd.setCursor(2,0);  
  lcd.print("July 12 2012 // CJQ");    
