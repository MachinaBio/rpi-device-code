...
{
	PID::SetOutputLimits(0, 255.0);				//default output limit corresponds to 
...
// **************************************************************************
// 3/8/2011, Carlo Quinonez - Patched to correct for irregular loop times
// **************************************************************************
      double timeCorrection = timeChange / SampleTime; 
      
      
	  double input = *myInput;
      double error = *mySetpoint - input;
      ITerm+= (ki * error * timeCorrection);
      if(ITerm > outMax) ITerm= outMax;
      else if(ITerm < outMin) ITerm= outMin;
      double dInput = (input - lastInput);
 
      /*Compute PID Output*/
      double output = kp * error + ITerm- ( kd * dInput / timeCorrection) ;
...
void PID::SetMode(int Mode)
{
    ...
    {  /*we just went from manual to auto*/
    	ITerm = 0; // clear the spooled up error. 
        PID::Initialize();
    }
    inAuto = newAuto;
}
