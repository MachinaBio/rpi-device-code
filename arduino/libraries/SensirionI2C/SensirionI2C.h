...
#ifndef SensirionI2C_h
#define SensirionI2C_h
...
#define PULSE_LONG  delayMicroseconds(15)
#define PULSE_SHORT delayMicroseconds(5)
...
class SensirionI2C
{
  ...
  public:
    SensirionI2C(uint8_t dataPin, uint8_t clockPin);
